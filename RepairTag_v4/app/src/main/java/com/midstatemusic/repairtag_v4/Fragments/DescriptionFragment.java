                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        if (Info.editing) {
                                            ...
                                            //String columns = "(type, first_name, last_name, address, city, state, zip, phone, email, school_district, school_building, teacher, instrument, brand, serial_number, mouth_piece, description, due_date, price, mp_coverage, status, employee_id)";
                                            String columns = "(type, first_name, last_name, address, city, state, zip, phone, email, school_district, school_building, teacher, instrument, brand, serial_number, mouth_piece, description, due_date, price, mp_coverage, status, date_sent, employee_id)";
                                            String value = "\"" + Info.type + "\", \"" + Info.firstName + "\", \"" + Info.lastName + "\", \"" + Info.address + "\", \"" + Info.city + "\", \"" + Info.state + "\", \"" + Info.zip + "\", \"" + Info.phone + "\", \"" + Info.email + "\", \"" + Info.schoolDistrict + "\", \"" + Info.schoolBuilding + "\", \"" + Info.teacher + "\", \"" + Info.instrument + "\", \"" + Info.brand + "\", \"" + Info.serialNumber + "\", " + Info.mouthPiece + ", \"" + Info.description + "\", \"" + Info.dueDate + "\", \"" + Info.price + "\", " + Info.mpCoverage + ", \"" + Info.status + "\", \"" + Info.createSentDate() + "\", \"" + Info.employeeID + "\"";
